...
import { CircleUserRound, ExternalLink, LogOut, Menu } from "lucide-react";
import { Brand } from "@/components/brand";
import { logout } from "@/app/dashboard/actions";
import { DashboardNavLink } from "@/components/dashboard-nav-link";

const items = [
  ["VisÃ£o geral", "/dashboard", "home"], ["Produtos", "/dashboard/produtos", "products"], ["Categorias", "/dashboard/categorias", "categories"], ["Pedidos", "/dashboard/pedidos", "orders"], ["Clientes", "/dashboard/clientes", "customers"], ["RelatÃ³rios", "/dashboard/relatorios", "reports"], ["Planos", "/dashboard/planos", "plans"],
] as const;
